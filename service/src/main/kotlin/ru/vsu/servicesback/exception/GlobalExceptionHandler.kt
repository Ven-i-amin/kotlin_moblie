...
import ru.vsu.servicesback.dto.response.ApiErrorResponse
...
class GlobalExceptionHandler {
    ...
    fun handleInvalidPassword(ex: InvalidPasswordException): ResponseEntity<ApiErrorResponse> =
        ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(ApiErrorResponse(ex.message ?: "Invalid credentials"))
